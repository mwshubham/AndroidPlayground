...
object Navigation3Transitions {
     ...
     */
    fun horizontalSlideTransition(durationMillis: Int = DEFAULT_ANIMATION_DURATION): AnimatedContentTransitionScope<Scene<NavKey>>.() -> ContentTransform =
     ...
     */
    fun horizontalSlidePopTransition(durationMillis: Int = DEFAULT_ANIMATION_DURATION): AnimatedContentTransitionScope<Scene<NavKey>>.() -> ContentTransform =
        createHorizontalSlideTransition(
     ...
     */
    fun predictivePopTransition(durationMillis: Int = PREDICTIVE_POP_DURATION): (AnimatedContentTransitionScope<Scene<NavKey>>, Int) -> ContentTransform =
        { scope, offset ->
            with(scope) {
                createHorizontalSlideTransition(
                    enterFromRight = false,
