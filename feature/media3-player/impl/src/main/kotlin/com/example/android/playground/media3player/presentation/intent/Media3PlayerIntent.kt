...
sealed interface Media3PlayerIntent {
    ...
    data class SeekTo(val positionMs: Long) : Media3PlayerIntent
    data class SelectVideo(val index: Int) : Media3PlayerIntent
    ...
    data class OnPlayerError(val message: String) : Media3PlayerIntent
    data class OnPositionChanged(val positionMs: Long, val durationMs: Long) : Media3PlayerIntent
}
