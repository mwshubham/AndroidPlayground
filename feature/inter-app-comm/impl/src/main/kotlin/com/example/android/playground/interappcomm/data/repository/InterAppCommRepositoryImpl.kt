...
class InterAppCommRepositoryImpl @Inject constructor(
     ...
     */
    override fun getAppSignatureFingerprint(packageName: String): String? = runCatching {
    ...
    override fun getIpcChannels(): List<IpcChannel> = listOf(
        IpcChannel(
