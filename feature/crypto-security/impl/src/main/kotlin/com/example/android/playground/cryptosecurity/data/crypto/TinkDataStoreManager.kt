    ...
    constructor(
        ...
        fun loadAndDecrypt(key: String): Flow<String?> =
            context.tinkDataStore.data.map { prefs ->
                ...
                aead
                    .decrypt(ciphertext, key.toByteArray(Charsets.UTF_8))
        ...
        fun loadRawCiphertext(key: String): Flow<ByteArray?> = context.tinkDataStore.data.map { prefs -> prefs[ciphertextKey(key)] }
